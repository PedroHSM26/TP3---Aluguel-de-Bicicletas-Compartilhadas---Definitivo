...
public class BicicletaController {
	...
	public static boolean devolverBicicleta(JFrame frame, Usuario usuario) {
	    ...
	    labels.add(new JLabel("<html>Voc� possui: "+usuario.getBicicletas() + " Bicicleta"
	    	...
	    	p.add(cancelar);
	    	 ...
	    	 labels.add(new JLabel("<html>Voc� possui: "+usuario.getBicicletas() + " Bicicletas"
	 	    		+"<br> do tipo: <span color = #38805F >"+ usuario.getPlanoAssinado()+ " </span>"
	    ...
	    labels.add(new JLabel("Voc� ainda n�o possui bicicletas", SwingConstants.TRAILING));
